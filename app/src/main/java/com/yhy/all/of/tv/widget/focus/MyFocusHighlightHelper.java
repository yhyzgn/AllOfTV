package com.yhy.all.of.tv.widget.focus;
...
public class MyFocusHighlightHelper {
    ...
    public static class BrowseItemFocusHighlight implements FocusHighlightHandler {
        ...
        private FocusAnimator getOrCreateAnimator(View view) {
            FocusAnimator animator = (FocusAnimator) view.getTag(androidx.leanback.R.id.lb_focus_animator);
            if (animator == null) {
                animator = new FocusAnimator(
                        view, getScale(view.getResources()), mUseDimmer, DURATION_MS);
                view.setTag(androidx.leanback.R.id.lb_focus_animator, animator);
            }
            return animator;
        }
    ...
    static class HeaderItemFocusHighlight implements FocusHighlightHandler {
        ...
        void lazyInit(View view) {
            if (!mInitialized) {
                ...
                res.getValue(androidx.leanback.R.dimen.lb_browse_header_select_scale, value, true);
                mSelectScale = value.getFloat();
                res.getValue(androidx.leanback.R.dimen.lb_browse_header_select_duration, value, true);
